...
void start_DODGEM()
{
	...
	game->MenuImage= loadBitmap(ImagesPath"MenuPrincipal.bmp");
	game->GameField= loadBitmap(ImagesPath"MenuGame.bmp");
	game->PlaySquare= loadBitmap(ImagesPath"MainSquare.bmp");
	game->EnemyBL= loadBitmap(ImagesPath"squareBL.bmp");
	game->EnemyBR= loadBitmap(ImagesPath"squareBR.bmp");
	game->EnemyTL= loadBitmap(ImagesPath"squareTL.bmp");
	game->EnemyTR= loadBitmap(ImagesPath"squareTR.bmp");
	game->Cursor = loadBitmap(ImagesPath"rato20.bmp");
	game->CursorLeft = loadBitmap(ImagesPath"rato20L.bmp");
	game->CursorRight = loadBitmap(ImagesPath"rato20R.bmp");
	game->CursorLR = loadBitmap(ImagesPath"rato20LR.bmp");
	game->CursorLRM = loadBitmap(ImagesPath"rato20LRM.bmp");
	game->CursorMiddle = loadBitmap(ImagesPath"rato20M.bmp");
	...
	game->space = loadBitmap(ImagesPath"space.bmp");
	game->MenuHighscore = loadBitmap(ImagesPath"MenuHighScores.bmp");
	game->HighscoreList = loadBitmap(ImagesPath"HighScoresList.bmp");
	game->Help = loadBitmap(ImagesPath"Help.bmp");
	game->Separadores = loadBitmap(ImagesPath"Separadores.bmp");
